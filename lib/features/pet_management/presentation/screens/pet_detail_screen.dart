...
class PetDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final animal = context.watch<AnimalListCubit>().state.animals.firstWhereOrNull((element) => element.id == petId);
            ...
            Stack(
              children: [
                      ...
                      children: [
                        Padding(
                          ...
                          child: PetsScreenOwnersComponent(
                            ...
                            onEditPressed: () => context.navigate(RouteNames.editAnimalId(animal.id!)),
                          ),
                        ),
                        Wrap(
                          spacing: 24,
                          children: [
                            PetsScreenDetailsCardComponents(color: Color(0xfffce5e0), gender: animal.gender?.name ?? "À renseigner", sex: "Sexe"),
                            PetsScreenDetailsCardComponents(
                                color: Color(0xffeaf9e7),
                                gender: Jiffy.parse(animal.birthDate!).diff(Jiffy.now(), unit: Unit.year).abs().toString(),
                                sex: "Age"),
                            if (animal.weight != null) PetsScreenDetailsCardComponents(color: Colors.blue.shade50, gender: "${animal.weight} Kg", sex: "Poids"),
                          ],
                        ),
                        SizedBox(height: 20),
                        FutureBuilder(
                          ...
                          builder: (context, snapshot) {
                            return Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                color: (snapshot.data?.isDark ?? false) ? Colors.black12 : Colors.white,
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      image: DecorationImage(
                                        image: AssetImage("assets/images/theme15/account_images/profile2.png"),
                                        fit: BoxFit.cover,
                                      ),
                                    ),
                                  ),
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            Expanded(
                                              child: Text(
                                                animal.owner!.address!.formattedAddress!,
                                                style: style2,
                                              ),
                                            )
                                          ],
                              ...
                              Row(
                                children: [
                                  Container(
                                    ...
                                    decoration: BoxDecoration(color: primarycolor, borderRadius: BorderRadius.circular(12), boxShadow: [
                                      BoxShadow(color: Colors.black12, blurRadius: 0.5, spreadRadius: 0.2, offset: Offset(1, 1)),
                                      BoxShadow(color: Colors.black12, blurRadius: 0.5, spreadRadius: 0.2, offset: Offset(0, 1)),
                                    ]),
                                    child: Image.asset(
                ...
                Positioned(
                  ...
                  width: MediaQuery.of(context).size.width - 32,
                  left: 16,
                  child: PetsScreenAppbarComponents(rightIconImage: "assets/images/theme15/icons/donation.png"),
                ),
              ],
            ),
          ],
